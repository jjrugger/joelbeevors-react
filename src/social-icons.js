...
function SocialIcons() {
  return (
    <div className="flex space-x-4 justify-center mt-4">
      ...
      >
        <svg className="w-10 h-10 fill-goth-orange hover:fill-light-orange" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      ...
      <a
        ...
        href="https://twitter.com/JoelBeevors"
        target="_blank"
        rel="noopener noreferrer"
        className="transition duration-300 ease-in-out transform hover:scale-110"
      >
